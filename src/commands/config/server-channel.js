const { SlashCommandBuilder, Interaction, gameOption, gameAutocomplete, handleGameOption, regionAutocomplete, regionOption, handleRegionOption } = require("./index.js");
const { ServerChannel } = require("../../models/index.js");

const ChannelManager = require("../../dataManager/managers/channelManager.js");
        ...
        .addSubcommand((subcommand) =>
            subcommand
                ...
                .addStringOption((option) =>
                    option.setName("type").setDescription("The type of channel").setRequired(true).addChoices(
                        {
                            name: "Voice",
                            value: "2",
                        },
