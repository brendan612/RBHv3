...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) => option.setName("summoner_name").setDescription("The user's new summoner name. Do not include the tag line.").setRequired(true))
        .addStringOption((option) => option.setName("tag_line").setDescription("The user's new tag line.").setRequired(true)),
    /**
     *
    ...
    async execute(interaction) {
        ...
        await userService.updateUserRiotAccount(targetUser.user_id, summoner_name, tag_line);
    },
};
