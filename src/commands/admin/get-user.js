...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) => option.setName("id").setDescription("The User's Discord ID").setRequired(false)),
    /**
     *
    ...
    async execute(interaction) {
        ...
        if (!user) {
            user = await interaction.guild.members.fetch(interaction.options.getString("id"));
        }
