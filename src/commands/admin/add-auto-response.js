...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) => option.setName("trigger").setDescription("The trigger for the auto response").setRequired(true))
        .addStringOption((option) => option.setName("response").setDescription("The response to the trigger").setRequired(true)),
    /**
     *
