...
const { gameOption, gameAutocomplete, handleGameOption } = require("./index.js");
...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand((subcommand) =>
            subcommand
                ...
                .addStringOption(gameOption("game", "The game to create the game mode for", true))
                .addStringOption((option) => option.setName("name").setDescription("Name of the game mode").setRequired(true)),
        )
        .addSubcommand((subcommand) =>
            subcommand
                .setName("toggle")
                .setDescription("Toggle a game mode")
                .addStringOption(gameOption("game", "The game to toggle the game mode for", true))
                .addStringOption((option) => option.setName("name").setDescription("Name of the game mode").setRequired(true).setAutocomplete(true)),
        ),
    /**
     *
    ...
    async execute(interaction) {
        if (interaction.options.getSubcommand() === "create") {
            ...
            await interaction.reply({
                content: `Game mode has been toggled ${gamemode.enabled ? "on" : "off"}`,
            });
        }
    },
