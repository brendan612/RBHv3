...
const { getSynergyStatsForUsers } = require("../../dataManager/queries/stats/stats.js");
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const { winsWith, winsAgainst, lossesWith, lossesAgainst } = await getSynergyStatsForUsers(player1.user_id, player2.user_id, game.game_id, season?.season_id);

        const embed = baseEmbed("Queen's Croquet Synergy Report", "Description", false);
