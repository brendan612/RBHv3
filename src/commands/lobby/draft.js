const { SlashCommandBuilder, Interaction, gameAutocomplete, lobbyAutocomplete, gameOption, lobbyOption, handleGameOption, handleLobbyOption, generateEmbed } = require("./index.js");
...
module.exports = {
    data: new SlashCommandBuilder().setName("draft").setDescription("Draft a lobby").addStringOption(gameOption()).addIntegerOption(lobbyOption()),
    /**
     *
