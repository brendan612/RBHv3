const { SlashCommandBuilder, Interaction, gameAutocomplete, lobbyAutocomplete, gameOption, lobbyOption, handleGameOption, handleLobbyOption, Lobby, Draft, DraftRound } = require("./index.js");
...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) => option.setName("name").setDescription("Name of the lobby").setRequired(true)),
    /**
     *
