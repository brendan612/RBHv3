...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("opgg")
        .setDescription("Get a link to a players op.gg profile. Will default to yourself")
        .addStringOption((option) => {
            return option.setName("summoner_name").setDescription("Summoner name to search for").setRequired(true);
        })
