...
const { SlashCommandBuilder, Interaction, User, userOption, regionOption, regionAutocomplete, handleRegionOption, handleUserOption } = require("./index.js");

const { hasRequiredRoleOrHigher } = require("../../utilities/utility-functions.js");

module.exports = {
    data: new SlashCommandBuilder().setName("change-region").setDescription("Change the region you are playing in").addStringOption(regionOption()).addUserOption(userOption()),
    /**
     *
