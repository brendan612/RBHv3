...
const { tournamentCreateSubCommand, handleTournamentCreate, generateTournamentCreateModal } = require("./tournament-subcommands/create.js");

module.exports = {
    data: new SlashCommandBuilder().setName("tournament").setDescription("Manage tournaments").addSubcommand(tournamentCreateSubCommand()),
    /**
     *
