...
class LobbyDTO {
    ...
    constructor(lobby) {
        ...
        try {
            ...
            const generalChannel = ChannelManager.getChannelViaServerChannel(lobby.game_id, lobby.region_id, "general");
            this.channels.set("general", generalChannel);

            const winsChannel = ChannelManager.getChannelViaServerChannel(lobby.game_id, lobby.region_id, "wins");
