const { ThreadChannel, TextChannel, EmbedBuilder, ActionRowBuilder, AttachmentBuilder } = require("discord.js");
...
class DraftManager {
     ...
     */
    async sendMessage(draft, channel, messageText, embed, components, attachments, ephemeral = false, useThread = true) {
        ...
        if (attachments) {
            messageOptions.files = Array.isArray(attachments) ? attachments : [attachments];
        }
