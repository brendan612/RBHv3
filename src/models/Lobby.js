...
const { lobbyEmbed, generatePlayerListForEmbed, generatePlayerRolesListForEmbed, generatePlayerRanksListForEmbed } = require("../components/lobbyEmbed.js");
const { GuildMember, Client, ButtonBuilder, ButtonStyle, ActionRowBuilder, Interaction, ButtonInteraction } = require("discord.js");
...
module.exports = (sequelize) => {
    ...
    class Lobby extends Model {
        ...
        static async getOpenLobbies(game_name = "League of Legends", region = "NA") {
            const User = require("./User.js")(sequelize);
